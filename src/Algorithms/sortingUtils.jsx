...
export function insertStep(newArray,position,arrayStep){
    let currentStep = arrayStep[arrayStep.length-1].slice();
    currentStep.splice(position,newArray.length,...newArray);
    arrayStep.push(currentStep);
}
